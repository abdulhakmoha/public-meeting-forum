...
/// Survives Android restart when picking a photo for new issue create.
class IssueDraftStore {
  static const _draftKey = 'issue_create_draft_v1';
  static const _resumeKey = 'issue_create_resume_v1';
  static const _stagedKey = 'issue_staged_files_v1';
  ...
  static Future<void> markResume() async {
    ...
    await prefs.setBool('project_progress_resume_v1', false);
  ...
  static Future<File> _manifestFile() async {
    ...
    return File('${support.path}/issue_staged/manifest.json');
  }
  ...
  static Future<List<Map<String, String>>> listStagedFromNative() async {
    try {
      final raw = await _pickerChannel.invokeMethod<String>('listStaged', {'purpose': 'issue'});

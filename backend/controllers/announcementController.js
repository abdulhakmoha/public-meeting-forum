          ...
          await sendEmail({
            ...
            html: `
              <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 8px;">
                ...
                <p>A new announcement has been posted in the Public Meeting & Community Forum Management System (PMCFMS):</p>
                <div style="background-color: #f8fafc; padding: 15px; border-left: 4px solid #0d9488; margin: 20px 0;">
                  ...
                  <p style="font-size: 12px; color: #64748b; font-weight: bold; text-transform: uppercase; margin-bottom: 10px;">Category: ${category}</p>
                ...
                <p style="font-size: 12px; color: #94a3b8; margin-top: 30px; text-align: center; border-top: 1px solid #e2e8f0; padding-top: 15px;">
                  This is an automated email from PMCFMS. Please do not reply directly to this message.
                </p>
              </div>
            `
          });
        } catch (emailErr) {
          console.error(`Failed to send announcement email to ${u.email}:`, emailErr.message);
        }
      });
    }).catch(err => console.error('Failed to retrieve users for announcement emails:', err));
